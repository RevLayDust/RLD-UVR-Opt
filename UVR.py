...
class ModelData():
    def __init__(self, model_name: str, 
        ...
        self.model_precision = normalize_model_precision(root.model_precision_var.get())
        self.is_adaptive_chunk = root.is_adaptive_chunk_var.get()
...
class MainWindow(TkinterDnD.Tk if is_dnd_compatible else tk.Tk):
    ...
    def menu_settings(self, select_tab_2=False, select_tab_3=False):#**
        ...
        if not is_macos and self.is_gpu_available:
            ...
            model_precision_Label = self.menu_title_LABEL_SET(settings_menu_format_Frame, 'Precision Mode Preset')
    ...
    def load_saved_vars(self, data):
        ...
        self.model_precision_var = tk.StringVar(value=normalize_model_precision(data.get('model_precision')))
        self.is_adaptive_chunk_var = tk.BooleanVar(value=data.get('is_adaptive_chunk', False))
    ...
    def load_saved_settings(self, loaded_setting: dict, process_method=None, is_default_reset=False):
        ...
        self.model_precision_var.set(normalize_model_precision(loaded_setting.get('model_precision')))
        self.is_adaptive_chunk_var.set(loaded_setting.get('is_adaptive_chunk', False))
    ...
    def save_values(self, app_close=True, is_restart=False, is_auto_save=False):
        ...
        main_settings={
            ...
            'model_precision': normalize_model_precision(self.model_precision_var.get()),
            'is_adaptive_chunk': self.is_adaptive_chunk_var.get(),
